...
These systems are nested and can be described an infinite number of ways, so I’ll use the one [Staci Haines](https://www.stacihaines.com) outlines in her somatic work—individual, family/intimate network, community, institution, social norms/historical forces, and spirit/landscape.

![Nested layers of systems](wmw/systems-of-shaping.png)
