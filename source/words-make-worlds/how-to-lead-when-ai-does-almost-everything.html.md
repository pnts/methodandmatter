...
The urgency and pressure to adopt AI is intense. I’m seeing a lot of organizations try and approach AI adoption through usage leaderboards, which can frustrate folks who prefer a more coherent approach.  

It can also create what some refer to as “the frozen middle”, the layer of management caught between C-Suite demands for AI integration and the rapid adoption of AI tools by individual contributors.
...
We’ll walk through the framework step by step. Along the way you might start to have your own intuitions about where AI fits, and I invite you to jot those down. This works better when we think collectively.

I’d love for this to turn into a conversation—I want to be clear I’m not presenting this as a closed and finished framework, but an evolving structure for thinking and understanding.
...
This obscures something that is absolutely critical for every leader to understand: that leadership, whatever your seniority, consists of four distinct roles: leading, directing, managing, and coaching.

It is this conflation between business dimensions and leadership roles that can make AI feel so threatening. As AI is integrated into organizations it plays well in the business dimensions—vision, decisions, processes, and people—it can analyze and refine purpose, model vision scenarios to support decision making, optimize and implement processes, and bring clarity to career progression and performance.
